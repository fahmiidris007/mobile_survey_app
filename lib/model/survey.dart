...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    roleParticipantName: roleParticipantNameValues.map[json["role_participant_name"]]!,
    departementId: json["departement_id"],
    departementName: json["departement_name"],
    siteLocationId: json["site_location_id"],
    siteLocationName: siteLocationNameValues.map[json["site_location_name"]]!,
    image: json["image"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "role_participant_name": roleParticipantNameValues.reverse[roleParticipantName],
...
enum SiteLocationName {
  EMPTY,
  THE_037_C_KEL
}

final siteLocationNameValues = EnumValues({
  "": SiteLocationName.EMPTY,
  "037C KEL": SiteLocationName.THE_037_C_KEL
});
